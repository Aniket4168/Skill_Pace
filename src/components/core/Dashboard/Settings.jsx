...
import { updateProfile, changePassword, updateDisplayPicture ,deleteProfile } from '../../../services/operations/SettingsApi'
...
const Settings = () => {
  ...
  const handleUpload = (e) => {
    ...
    updateDisplayPicture(token,file);
  }
  ...
  const onDeleteAccount = () => {
    if(window.confirm
      ("Are you sure you want to delete your account?")){
        deleteProfile(token,dispatch,navigate);
      }
        ...
        <div className='mx-auto w-11/12 max-w-[1000px] py-10'>
          ...
          <div className='flex items-center justify-between rounded-md border-[1px] border-richblack-700 bg-richblack-800 md:p-8 md:px-12 px-3 py-3 text-richblack-5'>
            <div className='flex items-center gap-x-4'>
              <img className='aspect-square w-[78px] rounded-full object-cover'  src={profilePicture} alt='Profile_Image'></img>
              ...
              <form onSubmit={handleUpload}>
                ...
                <input id='upload' type="file" onChange={handleFileChange} className="hidden" accept="image/png, image/jpg, image/jpeg"/></label>
